...
**Owns:** `analysis/*.py`  
**Depends on:** ENG, PKG  
**Last verified:** 2026-06-29 · Phase 9
...
- `compare_scenarios()` — run multiple scenarios, align metrics (subsystem keys + budget aliases).
...
| Scenario compare + CSV export | VERIFIED |
...
- `examples/run_sensitivity.py`, `examples/run_trade_study.py`, `examples/run_compare.py`